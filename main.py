...
while g==1:
    ...
    while l==1:
        ...
        if move==1 and grid[0][0]=="-":l=0;grid[0][0]='O';l=0
        if move==2 and grid[0][1]=="-":l=0;grid[0][1]='O';l=0
        if move==3 and grid[0][2]=="-":l=0;grid[0][2]='O';l=0
        if move==4 and grid[1][0]=="-":l=0;grid[1][0]='O';l=0
        if move==5 and grid[1][1]=="-":l=0;grid[1][1]='O';l=0
        if move==6 and grid[1][2]=="-":l=0;grid[1][2]='O';l=0
        if move==7 and grid[2][0]=="-":l=0;grid[2][0]='O';l=0
        if move==8 and grid[2][1]=="-":l=0;grid[2][1]='O';l=0
        if move==9 and grid[2][2]=="-":l=0;grid[2][2]='O';l=0
    l=1;print(grid[0][0],end=" ");print(grid[0][1],end=" ");print(grid[0][2]);print(grid[1][0],end=" ");print(grid[1][1],end=" ");print(grid[1][2]);print(grid[2][0],end=" ");print(grid[2][1],end=" ");print(grid[2][2])
