...
while True:   
    ...
    while True:
        ...
        elif grid[0].count('-')==0 and grid[1].count('-')==0 and grid[2].count('-')==0:print(grid[0][0],end=' ');print(grid[0][1],end=' ');print(grid[0][2]);print(grid[1][0],end=' ');print(grid[1][1],end=' ');print(grid[1][2]);print(grid[2][0],end=' ');print(grid[2][1],end=' ');print(grid[2][2]);print('It was a draw');break
        while grid[0].count('-')+grid[1].count('-')+grid[2].count('-')!=0:
            if grid[0][0]==grid[0][1] and grid[0][0]=='O' and grid[0][2]=='-':grid[0][2]='O';break
                ...
                if grid[1][1]=="-":grid[1][1]='O';break
                    ...
                    if move==1 and grid[0][0]=='-':l=0;grid[0][0]='O';break
                    if move==2 and grid[0][1]=='-':l=0;grid[0][1]='O';break
                    if move==3 and grid[0][2]=='-':l=0;grid[0][2]='O';break
                    ...
                    if move==7 and grid[2][0]=='-':l=0;grid[2][0]='O';break
                    if move==8 and grid[2][1]=='-':l=0;grid[2][1]='O';break
                    if move==9 and grid[2][2]=='-':l=0;grid[2][2]='O';break
